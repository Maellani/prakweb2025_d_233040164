            ...
            <h3>Daftar Mahasiswa</h3>
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?= BASEURL; ?>/Mahasiswa/ubah/<?= $mhs['id']; ?>" class="badge text-bg-warning me-1 tampilModalUbah" data-bs-toggle="modal" data-bs-target="#formModal" data-id="<?= $mhs['id']; ?>">Ubah</a>
